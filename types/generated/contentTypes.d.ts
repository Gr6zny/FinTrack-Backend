...
export interface ApiAccountAccount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credit_limit: Schema.Attribute.Decimal;
    currency: Schema.Attribute.String;
    icon: Schema.Attribute.String;
    is_active: Schema.Attribute.Boolean;
    last_four_digits: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::account.account'
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    recurring_transactions: Schema.Attribute.Relation<
      'oneToMany',
      'api::recurring-transaction.recurring-transaction'
    >;
    ...
    type: Schema.Attribute.Enumeration<
      ['cash', 'bank_card', 'credit_card', 'digital', 'savings', 'investment']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBudgetBudget extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    spent_amount: Schema.Attribute.Decimal;
    start_date: Schema.Attribute.Date;
    threshold_percent: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    budget_limit: Schema.Attribute.Decimal;
    ...
    transactions: Schema.Attribute.Relation<
      ...
      'api::transaction.transaction'
    >;
    type: Schema.Attribute.Enumeration<['expense', 'income']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDebtDebt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['i_owe', 'owe_me']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface ApiRecurringTransactionRecurringTransaction
  extends Struct.CollectionTypeSchema {
  collectionName: 'recurring_transactions';
  info: {
    displayName: 'RecurringTransaction';
    pluralName: 'recurring-transactions';
    singularName: 'recurring-transaction';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    >;
    is_active: Schema.Attribute.Boolean;
    last_processed: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::recurring-transaction.recurring-transaction'
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_saved: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::report.report'
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<
      ['monthly', 'yearly', 'custom', 'category']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTagsTags extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tags.tags'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    account_from: Schema.Attribute.Relation<
      'manyToOne',
      'api::account.account'
    >;
    account_to: Schema.Attribute.Relation<'manyToOne', 'api::account.account'>;
    amount: Schema.Attribute.Decimal;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    type: Schema.Attribute.Enumeration<['expense', 'income', 'transfer']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    account: Schema.Attribute.Relation<'oneToMany', 'api::account.account'>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.String;
    debts: Schema.Attribute.Relation<'oneToMany', 'api::debt.debt'>;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    > &
      Schema.Attribute.Private;
    monthly_budget: Schema.Attribute.Decimal;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    savings_goal: Schema.Attribute.Decimal;
    tags: Schema.Attribute.Relation<'oneToMany', 'api::tags.tags'>;
    transactions: Schema.Attribute.Relation<
      'oneToMany',
      'api::transaction.transaction'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::recurring-transaction.recurring-transaction': ApiRecurringTransactionRecurringTransaction;
